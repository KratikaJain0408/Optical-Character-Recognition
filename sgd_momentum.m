...
for i = 1:length(params)
    params_winc{i}.b = (mu.*param_winc{i}.b) + (b_rate.*param_grad{i}.b);
    params_winc{i}.w = (mu.*param_winc{i}.w) + (w_rate.*(param_grad{i}.w + weight_decay.*params{i}.w));
    params{i}.b = params{i}.b - params_winc{i}.b;
    params{i}.w = params{i}.w - params_winc{i}.w;
end
% implementation ends
